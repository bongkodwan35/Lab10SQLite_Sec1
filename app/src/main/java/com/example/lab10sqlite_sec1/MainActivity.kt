...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        callStudentData()
        recycler_view.adapter = StudentsAdapter(student,applicationContext)
    ...
    fun editDeleteDialog(position: Int){
        ...
        mDialogView.btnUpdate.setOnClickListener{
            ...
            if (result!! > -1){
                Toast.makeText(applicationContext , "The student is update sucessfully" , Toast.LENGTH_SHORT).show()
                callStudentData()
